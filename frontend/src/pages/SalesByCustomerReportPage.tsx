...
export function SalesByCustomerReportPage() {
  return (
    ...
    >
      <SalesByCustomerReportContent />
    </RequirePermission>
  );
}

export function SalesByCustomerReportContent() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-bold text-gray-800">Reporte de Ventas por Cliente</h1>
